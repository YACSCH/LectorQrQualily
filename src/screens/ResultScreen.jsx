...
import { View, Text, StyleSheet, TouchableOpacity, Linking, Alert, SafeAreaView, Dimensions, ScrollView } from 'react-native';
      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.header}>
            <Ionicons name="checkmark-circle" size={width * 0.10} color="#4CAF50" />
          ...
          <View style={styles.content}>
            ...
            <View style={styles.card}>
              ...
              {resultado.informe ? (
                <>
                  <TouchableOpacity style={styles.linkButton} onPress={() => openUrl(resultado.informe)}>
            ...
            <View style={styles.card}>
              ...
              {resultado.certificado ? (
                <>
                  <TouchableOpacity style={styles.linkButton} onPress={() => openUrl(resultado.certificado)}>
...
const styles = StyleSheet.create({
  ...
  cardHeader: {
    ...
    paddingBottom: Dimensions.get('window').height * 0.010,
  },
  cardTitle: {
